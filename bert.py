...
class ClassificationModel:
    ...
    def train(
        ...
        **kwargs,
        ...
        accuracy = evaluate_val_accuracy(self,"./MAMS/MAMS_val.txt")
        ...
        for _ in train_iterator:
            ...
            if accuracy > best_accuracy:
                ...
                print('---test dataset----')
                test_acc = evaluate_val_accuracy(self,"./MAMS/MAMS_test.txt")
                with open('./MAMS_bert_best_accuracy.txt', 'a') as f0:
