    ...
    def train(
        ...
        **kwargs,
        ...
        for _ in train_iterator:
            ...
            epoch_number += 1
            accuracy = evaluate_val_accuracy_acd(self,"./MAMS_acd_data/MAMS_val.txt")
            if accuracy > best_accuracy:
                ...
                print('---test dataset----')
                test_acc = evaluate_val_accuracy_acd(self,"./MAMS_acd_data/MAMS_test.txt")
                with open('./MAMS_acd_bert_best_accuracy.txt', 'a') as f0:
